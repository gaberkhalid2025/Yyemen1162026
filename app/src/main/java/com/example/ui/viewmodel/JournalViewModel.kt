...
class JournalViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val allBookings: StateFlow<List<BookingSlot>>
    ...
    init {
        ...
        repository = JournalRepository(database.journalDao(), application)
    ...
    // Bookings - ViewModel methods
    fun persistBooking(booking: BookingSlot) {
        viewModelScope.launch {
    ...
    // App Notifications - ViewModel methods
    ...
    fun reconnectFirestore() {
        viewModelScope.launch {
            repository.reconnectFirestore()
        }
    }
